 ...
 * @returns The opcode if the buffer is a minimal OP, otherwise undefined.
 */
...
/**
 * @param buffer - The buffer to check.
 * @returns True if the buffer is a canonical public key, otherwise false.
 */
export function isCanonicalPubKey(buffer: Buffer) {
  return ecc.isPoint(buffer);
}

// https://github.com/bitcoinjs/bitcoinjs-lib/blob/master/test/integration/script.js
