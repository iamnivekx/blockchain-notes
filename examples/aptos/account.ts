...
async function main() {
	const signingMessage = new HexString('0x4cd1').toUint8Array();
	const privateKeyHex = '0x4cd1fff838717a1a175df49a502107f0377476a79d256ecd696121f72226a61c';
	const aptosCoin = '0x1::coin::CoinStore<0x1::aptos_coin::AptosCoin>';
	const privateKeyHexStr = new HexString(privateKeyHex);
	const NODE_URL = 'https://fullnode.devnet.aptoslabs.com';
	const FAUCET_URL = 'https://faucet.devnet.aptoslabs.com';

	const account = new AptosAccount(privateKeyHexStr.toUint8Array());
	const address = account.address();
	// public key -> address
	{
		const pubKeyHexStr = HexString.ensure('0xacdf5b6a88282858e157589119ea965cdeedab5f062ee3fb252b65cb15f7cbe9');
	...
	// sign
	{
		...
		console.log('signedMsg : ', HexString.fromUint8Array(signedMsg).hex());
	}
	{
		const pubKeyHexStr = HexString.ensure('0xacdf5b6a88282858e157589119ea965cdeedab5f062ee3fb252b65cb15f7cbe9');
		const address = pubKeyToAddress(pubKeyHexStr.toUint8Array());
